...
const BannerCard = ({setSearch}) => {
    ...
    return (   
                <div className="text-center flex flex-col mt-24">
                    ...
                    <div className="flex my-10 w-1/3 mx-auto items-center">
                        <input type="text" value={userInput} onChange={handleOnChange} className="flex-1 p-2 h-12 w-10 rounded-r-none rounded-lg border-2" placeholder="Search Here..." />
